...
| カテゴリ           | 技術                                               |
| ------------------ | -------------------------------------------------- |
| **バックエンド**   | Ruby 3.3.10 / Ruby on Rails 7.2.2                |
| **フロントエンド** | TypeScript 5.9.3/ React 19.2.7 / vite 7.3.1        |
| **データベース**   | MySQL                                         |
| **インフラ**       | AWS（EC2/S3/ALB/CDN/RDB/DynamoDB）  terrafomeで管理      |
| **サーバー**       | PUMA　　　　　　　　　　　　　　　　　　　　　　　　　|
| **キャッシュ**     | Redis                                              |
...
| **テストツール**   | RSpec / FactoryBot / Capybara 　　　　　　　　　　　　|

## インフライメージ
https://www.figma.com/board/TK6MgaS5a4OTgUEaQmHeCh/%E7%84%A1%E9%A1%8C?node-id=0-1&p=f&t=c55KQV8Avtz7bqlx-0
